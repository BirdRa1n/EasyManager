...
const ServiceDetail = () => {
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-screen gap-4">
                <Spinner size="lg" />
                <p className="text-base">Carregando detalhes do serviço...</p>
            </div>
        );
    }
    ...
    return (
        <>
            ...
            `}</style>
            <section className="p-6 md:p-10 max-w-7xl mx-auto h-screen overflow-auto no-scrollbar">
                <div className="mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="lg:col-span-2">
                        ...
                        <CardBody className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            />
                            {service.custom_attributes?.Garantia && (
                                <Input
                                    label="Garantia"
                                    value={service.custom_attributes.Garantia}
                                    description="Validade da garantia"
                                />
                            )}
                            <Textarea
                                label="Descrição"
                    ...
                    <Card>
                        ...
                        <CardBody className="space-y-4">
                            ...
                            {service.team.logo && (
                                <div>
                                    <p className="text-sm font-medium mb-2">Logo da Empresa</p>
                                    <Image
